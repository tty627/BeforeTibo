...
| macOS remote CI | macOS 26.6.2 (25G83), arm64; Node 24.20.0 / npm 11.19.0 / Git 2.55.0 | Actual required sandbox/browser checks, full suite, contracts, integration, build, DEMO, pack and scan passed |
...
| Linux | GitHub-hosted Ubuntu 24.04.5 LTS, Node 24.20.0 | [Push CI passed](https://github.com/tty627/BeforeTibo/actions/runs/35699251338): tests/build/DEMO/pack/scan. Executable sandbox backend not implemented; execution remains BLOCKED |
...
Remote push workflow [35699251338](https://github.com/tty627/BeforeTibo/actions/runs/35699251338) passed on both ubuntu-latest and macos-latest. macOS required executable sandbox/browser checks; Linux exercised supported offline behavior and unsupported-execution rejection. A fork-PR workflow event was not exercised. CI uses no personal Codex account or model calls.
